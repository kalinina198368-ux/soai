// * +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// * Copyright 2023 The So-AI Authors. All rights reserved.
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "/admin/mj/material",
        name: "admin-mj-material",
        meta: { title: "素材管理" },
        component: () => import("@/views/admin/MjMaterial.vue"),
      },
      {
        path: "/admin/medias",
        name: "admin-medias",
      ...
      {
        path: "/admin/pointsLog",
        name: "admin-points-log",
        meta: { title: "积分日志" },
  ...
  },
  {
    ...
    path: "/mobile/reg",
    meta: { title: "用户注册" },
    component: () => import("@/views/mobile/Reg.vue"),
  },
  {
    name: "mobile",
    path: "/mobile",
    ...
    children: [
      {
        ...
        name: "mobile-home",
        redirect: (to) => {
          return { path: "/mobile/index", query: to.query };
        },
      },
      {
        path: "/mobile/index",
      ...
      },
      {
        ...
        name: "mobile-material-list",
        component: () => import("@/views/mobile/pages/MaterialList.vue"),
      },
      {
        path: "/mobile/prompt-editor",
        name: "mobile-prompt-editor",
        component: () => import("@/views/mobile/pages/PromptEditor.vue"),
      },
      {
        path: "/mobile/upload",
        name: "mobile-upload-by-code",
        meta: { title: "扫码上传" },
        component: () => import("@/views/mobile/pages/UploadByCode.vue"),
      },
      {
        path: "/mobile/profile",
        name: "mobile-profile",
      ...
      {
        path: "/mobile/test-sora",
        name: "mobile-test-sora",
        component: () => import("@/views/mobile/TestSora.vue"),
      },
      {
        path: "/mobile/powerlog",
        name: "mobile-power-log",
        component: () => import("@/views/mobile/PowerLog.vue"),
      },
      {
        path: "/mobile/pointslog",
        name: "mobile-points-log",
        component: () => import("@/views/mobile/PointsLog.vue"),
      },
      {
        path: "/mobile/team",
        name: "mobile-team",
        component: () => import("@/views/mobile/Team.vue"),
      },
      {
      ...
      },
      {
        ...
        name: "mobile-help",
        meta: { title: "帮助中心" },
        component: () => import("@/views/mobile/HelpCenter.vue"),
      },
      {
        path: "/mobile/video-square",
        name: "mobile-video-square",
        meta: { title: "视频广场" },
        component: () => import("@/views/mobile/VideoSquare.vue"),
      },
      {
        path: "/mobile/share",
        name: "mobile-share",
