...
const (
	...
	PowerSend       = PowerType(7)  // 转账
	PowerRece       = PowerType(8)  // 收款
	PowerSale       = PowerType(9)  // 佣金
	PowerWithdraw   = PowerType(10) // 提现
	PowerWithdrawNG = PowerType(11) // 退款
	PowerTeamReward = PowerType(12) // 团队奖
)
...
func (t PowerType) String() string {
	...
	case PowerWithdraw:
		return "提现"
	case PowerWithdrawNG:
		return "退款"
	case PowerTeamReward:
		return "团队奖"
	}
	return "其他"
}
